...
public class C extends LKApiBusUpdateUsingStatusController<LKRequestIDsBean, SysAppVersionEntity> {
	...
	@Override
	protected LKApiBusUpdateUsingStatusService<LKRequestIDsBean, SysAppVersionEntity> getService(LKRequestIDsBean cin, ApiKeyValues<LKRequestIDsBean> params) {
		return service;
	}
