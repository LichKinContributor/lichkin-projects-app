...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API + "/SysAppBanner/I")
...
public class C extends LKApiBusInsertController<I, SysAppBannerEntity> {
	...
	@Override
	protected LKApiBusInsertWithoutCheckerService<I, SysAppBannerEntity> getService(I cin, ApiKeyValues<I> params) {
		return service;
	}
