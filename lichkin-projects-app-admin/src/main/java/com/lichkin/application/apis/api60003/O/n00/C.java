...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API + "/SysAppNews/O")
...
public class C extends LKApiBusGetOneController<I, O, SysAppNewsEntity> {
	...
	@Override
	protected LKApiBusGetOneService<I, O, SysAppNewsEntity> getService(I cin, ApiKeyValues<I> params) {
		return service;
	}
