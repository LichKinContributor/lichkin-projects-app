...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API_WEB_ADMIN + "/SysAppNews/U")
...
public class C extends LKApiBusUpdateController<I, SysAppNewsEntity> {
	...
	@Override
	protected LKApiBusUpdateWithoutCheckerService<I, SysAppNewsEntity> getService(I cin) {
		return service;
	}
